...
#ifdef WIN32
#ifdef __STDC__
void X_set_pre_xevent_handler(Bool (*function)(MSG *e))
#else
...
#ifdef __STDC__
void X_set_post_xevent_handler(void (*function)(MSG *e))
#else
...
#ifdef MACOS
#ifdef __STDC__
void X_set_pre_xevent_handler(Bool (*function)(EventRecord *e))
#else
void X_set_pre_xevent_handler(function)
void (*function)();
#endif
...
#ifdef __STDC__
void X_set_post_xevent_handler(void (*function)(EventRecord *e))
#else
void X_set_post_xevent_handler(function)
void (*function)();
#endif
...
#ifdef __STDC__
void X_set_post_poll_handler(void (*function)())
#else
void X_set_post_poll_handler(function)
void (*function)();
#endif
{
}
